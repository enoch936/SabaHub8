      ...
      <div className="relative flex h-full min-h-0">
        ...
        >
          <div className="border-b border-[#dfe5dc] px-4 py-4">
            ...
            <div className="mt-4 flex items-center gap-3 rounded-[22px] border border-[#d9e1d7] bg-white px-4 py-3 shadow-[0_16px_30px_rgba(38,67,56,0.06)]">
          ...
          {showComposerPanel ? (
            <div className="space-y-4 border-b border-[#dfe5dc] bg-[linear-gradient(180deg,rgba(241,245,240,0.9),rgba(248,246,240,0.78))] px-4 py-4">
              <div className="rounded-[26px] border border-[#d8e0d6] bg-white px-4 py-4 shadow-[0_20px_32px_rgba(38,67,56,0.05)]">
                <div className="flex items-start justify-between gap-3">
                  <div>
                ...
                <div className="mt-4 flex items-center gap-2 rounded-[18px] border border-[#d8e0d6] bg-[#f6f8f3] px-3 py-2">
                  ...
                  <button
                    type="button"
                    onClick={() => void handleStartDirectFromIdentifier()}
              ...
              <div className="rounded-[26px] border border-[#d8e0d6] bg-white px-4 py-4 shadow-[0_20px_32px_rgba(38,67,56,0.05)]">
                ...
                <div className="mt-4 flex gap-2">
                  <button
                    ...
                    className="inline-flex flex-1 items-center justify-center gap-2 rounded-[18px] bg-[#27463b] px-4 py-3 text-sm font-semibold text-white shadow-[0_18px_30px_rgba(39,70,59,0.2)] transition hover:bg-[#315447]"
                  >
                  ...
                  <button
                    ...
                    className="rounded-[18px] border border-[#d8e0d6] bg-[#f6f8f3] px-4 py-3 text-sm font-semibold text-[#5e6d65] transition hover:bg-white"
                  >
                    Clear
                  </button>
                </div>
