    ...
    return (
      <div className="group bg-white rounded-lg shadow-sm hover:shadow-md transition overflow-hidden">
        <div className="p-4">
          ...
          {/* Title - Bold & Colored */}
          <h3 className="text-base font-bold text-green-600 mb-1 hover:underline cursor-pointer">
            {job.title}
          </h3>
          ...
          <p className="text-sm text-gray-700 mb-2 leading-relaxed">
            {expanded ? job.description : job.description.substring(0, 200)}
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            {job.skills.slice(0, 6).map((skill) => (
              <span key={skill} className="inline-block bg-gray-200 text-gray-700 px-2.5 py-0.5 rounded text-xs font-medium">
                {skill}
              </span>
            ))}
          </div>
          ...
          <div className="flex items-center gap-2 text-xs text-gray-600 border-t border-gray-200 pt-2">
            ...
            {job.employerRating && (
              <span className="text-orange-500">⭐⭐⭐⭐⭐ {job.employerRating}</span>
            )}
