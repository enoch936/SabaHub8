  ...
  return (
    ...
    >
      <div className="border-b border-[#d8e0d6] bg-[rgba(250,247,239,0.88)] px-4 py-4 backdrop-blur-md">
        ...
        {searchOpen ? (
          <div className="mt-4 rounded-[22px] border border-[#d8e0d6] bg-white px-4 py-3 shadow-[0_18px_28px_rgba(38,67,56,0.05)]">
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="w-full bg-transparent text-sm text-[#20332d] outline-none placeholder:text-[#94a198]"
              />
              {hasSearchQuery ? (
                <span className="rounded-full bg-[#edf4ec] px-2.5 py-1 text-[11px] font-semibold text-[#315447]">
