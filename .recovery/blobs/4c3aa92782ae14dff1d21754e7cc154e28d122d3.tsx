        ...
        >
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1, minWidth: 0, flexShrink: 0 }}>
            ...
            <Box sx={{ display: { xs: "none", sm: "block" }, minWidth: 0 }}>
              <Typography sx={{ fontSize: "0.84rem", fontWeight: 700, lineHeight: 1.1, color: "#0f172a" }} noWrap>
                SabaHub
              </Typography>
              <Typography
                sx={{
          ...
          <TextField
            ...
            sx={{
              ...
              "& .MuiOutlinedInput-root": {
                ...
                pr: 0.5,
                boxShadow: "0 10px 24px rgba(15,23,42,0.04)",
                "& fieldset": { border: "1px solid rgba(15, 23, 42, 0.08)" },
                "&:hover fieldset": { border: "1px solid rgba(15, 23, 42, 0.12)" },
                "&.Mui-focused fieldset": { border: "1px solid rgba(15, 23, 42, 0.16)" },
              },
            }}
            InputProps={{
              startAdornment: (
          ...
          <Box sx={{ ml: "auto", display: "flex", alignItems: "center", gap: 1 }}>
            ...
            <Stack direction="row" alignItems="center" spacing={1.25}>
              <Box sx={{ display: { xs: "none", sm: "block" }, textAlign: "right" }}>
                <Typography sx={{ fontSize: "0.875rem", fontWeight: 600, lineHeight: 1.2, color: "#0f172a" }} noWrap>
                  {displayName}
                </Typography>
                <Typography sx={{ fontSize: "0.72rem", color: "#64748b", textTransform: "capitalize", lineHeight: 1.2 }} noWrap>
                  {roleLabel}
                </Typography>
              </Box>
