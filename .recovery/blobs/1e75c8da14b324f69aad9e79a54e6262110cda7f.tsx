  ...
  const actionButtons = (
    <div className="flex flex-wrap items-center gap-1.5">
      <button
        type="button"
        onClick={() => onApply(job)}
        className="inline-flex items-center gap-1 rounded-lg bg-gray-950 px-2.5 py-1.5 text-xs font-medium text-white transition hover:bg-gray-800"
      >
      ...
      <button
        ...
        className="inline-flex items-center gap-1 rounded-lg border border-[var(--border)] bg-white px-2.5 py-1.5 text-xs font-medium text-gray-700 transition hover:bg-gray-50"
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 grid gap-2 sm:grid-cols-2 xl:grid-cols-2">
            ...
            <div className="rounded-[14px] bg-white px-2 py-1.5 shadow-[0_6px_14px_rgba(15,23,42,0.02)]">
              ...
              <p className="mt-0.5 inline-flex items-center gap-0.5 text-xs font-semibold text-gray-900">
