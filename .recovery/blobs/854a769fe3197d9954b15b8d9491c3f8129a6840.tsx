  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
        ...
        <div className="mt-6">
          {remoteMedia ? (
            ...
            <StreamVideoStage
              ...
              fallbackSrc={playbackSource.fallbackUrl}
              ...
              detail={
                stream?.status === "LIVE"
                  ...
                  : "The replay or preview is ready to play here, with a bundled demo video covering the gap while the live media source reconnects."
              }
      ...
      <aside className="rounded-[28px] border border-gray-200/80 bg-white p-6 shadow-[0_18px_44px_rgba(15,23,42,0.04)]">
        ...
        <p className="mt-2 text-sm text-gray-500">Chat rides the existing STOMP stack and is ready to move to a broker relay for scale.</p>
        ...
        <form onSubmit={handleSend} className="mt-4 grid gap-3">
          <textarea
            ...
            rows={3}
            placeholder="Say something helpful to the stream..."
