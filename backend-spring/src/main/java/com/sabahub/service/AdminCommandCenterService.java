...
public class AdminCommandCenterService {
    ...
    private Snapshot buildSnapshot() {
        ...
        double cpu = meterRegistry.find("system.cpu.usage").gauge() != null ? meterRegistry.get("system.cpu.usage").gauge().value() : 0.0;
        double memUsed = meterRegistry.find("jvm.memory.used").gauge() != null ? meterRegistry.get("jvm.memory.used").gauge().value() : 0.0;
        double memMax = meterRegistry.find("jvm.memory.max").gauge() != null ? meterRegistry.get("jvm.memory.max").gauge().value() : 1.0;
        double uptimeSec = meterRegistry.find("process.uptime").gauge() != null ? meterRegistry.get("process.uptime").gauge().value() : 0.0;
