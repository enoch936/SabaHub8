        ...
        <div className="flex h-48">
          ...
          <div className="w-[70%] flex">
            ...
            <div className="w-32 h-48 flex-shrink-0">
              {activeMedia ? (
                <div className="relative w-full h-full overflow-hidden bg-[var(--accent)] transition duration-200 group-hover:shadow-md">
                  ...
                  {totalMedia > 1 && (
                    <>
                      <button
                        ...
                        className="absolute left-1 top-1/2 -translate-y-1/2 rounded-full bg-white/80 p-1 text-gray-700 shadow-sm hover:bg-white"
                      ...
                      <button
                        ...
                        className="absolute right-1 top-1/2 -translate-y-1/2 rounded-full bg-white/80 p-1 text-gray-700 shadow-sm hover:bg-white"
                ...
                <div className="w-full h-full bg-gray-50/90 flex items-center justify-center">
                  <PlayCircle className="h-5 w-5 text-gray-300" />
                </div>
              )}
            </div>
              ...
              <div>
                <div className="flex items-center justify-between gap-2 mb-2">
                  <div className="flex items-center gap-2 text-[10px] text-gray-600">
                    ...
                    <span>•</span>
                    <span>{job.proposalCount || "5-10"} proposals</span>
                  </div>
                  <button
                    type="button"
                ...
                <div className="text-[11px] text-gray-700 font-medium mb-2">
                ...
                <div className="flex flex-wrap gap-1">
                  {job.skills.slice(0, 4).map((skill) => (
                    <span key={skill} className="inline-block bg-blue-50 text-blue-700 px-2 py-0.5 rounded text-[9px] font-medium">
                      {skill}
                    </span>
                  ))}
                </div>
          ...
          {/* RIGHT 30% - White Space with Action Buttons */}
          <div className="w-[30%] bg-gradient-to-l from-gray-50 to-white flex flex-col items-center justify-center gap-2 px-3">
            <button
              type="button"
              onClick={() => onApply(job)}
              className="w-full px-2 py-2 bg-gray-900 text-white text-xs font-semibold rounded hover:bg-gray-800 transition"
            >
              Apply
            </button>
            <button
              ...
              className="w-full px-2 py-2 border border-gray-300 bg-white text-gray-700 text-xs font-medium rounded hover:bg-gray-50 transition"
            >
              {expanded ? "Less" : "Show"}
            </button>
            <button
